...
estimation_data_prep <- function(population_data, select_state_fips, select_county_fips) {
  # the select_county_fips is an integer code including state fips, e.g. 6001
  # the select_state_fips is an integer code of state fips, e.g. 6 for California
