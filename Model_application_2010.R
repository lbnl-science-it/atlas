...
num_power <- 4 # number of powertrain for step 7 estimation (5+) #update 10.22
controls <- list()
...
# before update without location fixed effects
# 2009 v3
apollo_beta = c(alpha_base    = 0,
                ...
                # delta_suv3_child    = 0,
                delta_pickup1    = 0,
                # delta_pickup1_marin    = 0,
                delta_pickup1_sm    = 0,
                # delta_pickup1_solano    = 0,
                delta_pickup1_sonoma    = 0,
                # delta_pickup1_cc    = 0,
                # delta_pickup1_urban_cbsa    = 0,
                # delta_pickup1_HHSIZE1    = 0,
                # delta_pickup1_income5    = 0,
                delta_pickup2    = 0,
                # delta_pickup2_marin    = 0,
                # delta_pickup2_napa    = 0,
                delta_pickup2_solano    = 0,
                delta_pickup2_sonoma    = 0,
                # delta_pickup2_cc    = 0,
                delta_pickup2_child    = 0,
                # delta_pickup2_income1    = 0,
                delta_pickup3    = 0,
                # delta_pickup3_napa    = 0,
                # delta_pickup3_sm    = 0,
                delta_pickup3_solano    = 0,
                delta_pickup3_sonoma    = 0,
                # delta_pickup3_cc    = 0,
                delta_pickup3_income2    = 0,
                delta_pickup3_child    = 0,
                delta_motorbike  = 0,
                # delta_motorbike_cc  = 0,
                # delta_motorbike_sf    = 0,
