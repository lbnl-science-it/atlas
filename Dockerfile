...
RUN  cd / \
  ...
  && echo  "Dockerfile 2021.1212.1608 foreach doSNOW lib-pacman apollo optparse integration"     >> _TOP_DIR_OF_CONTAINER_   \
  && echo  "Grand Finale"
...
ENV DBG_ATLAS_VER       "2021.1212.1608 optparse integration"
